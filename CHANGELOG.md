...
## [v2.8.2](https://github.com/netlify/build-image/compare/v2.8.1...v2.8.2) - 2019-05-09

### Commits

- Fix NETLIFY=true CI environment signal [`687d5af`](https://github.com/netlify/build-image/commit/687d5af4398033a33e5d7a51eb8cd7980cbd5db6)

## [v2.8.1](https://github.com/netlify/build-image/compare/v2.8.0...v2.8.1) - 2019-05-08

### Merged

- Backport ZISI in build function to trusty [`#312`](https://github.com/netlify/build-image/pull/312)

### Commits

- Sync package.json [`8d744e3`](https://github.com/netlify/build-image/commit/8d744e3e2be355ea63a6b1ed40fd0e717eacdfa5)

## [v2.8.0](https://github.com/netlify/build-image/compare/v2.7.4...v2.8.0) - 2019-04-30

### Merged

- Add Zip-it-and-ship-it ENV var to trusty image [`#306`](https://github.com/netlify/build-image/pull/306)

### Commits

- Link the custom version of ZISI [`2cbef97`](https://github.com/netlify/build-image/commit/2cbef97a958b56e95179a0c42de881ce32ccfc52)
- Fix output when installing ZISI [`b443916`](https://github.com/netlify/build-image/commit/b4439164cc636eb9b564bed2755ef624b19fe703)

## [v2.7.4](https://github.com/netlify/build-image/compare/v2.7.3...v2.7.4) - 2019-04-22

### Commits

- Update ZISI to 0.3.1 [`68eb77b`](https://github.com/netlify/build-image/commit/68eb77b12dcaf4445a17553ab7474f21f0a43ad1)

## [v2.7.3](https://github.com/netlify/build-image/compare/v2.7.2...v2.7.3) - 2019-04-15

### Commits

- fix package json version [`dd717ec`](https://github.com/netlify/build-image/commit/dd717ece4cb071fc32f8ac789981ebb8b4089903)

## [v2.7.2](https://github.com/netlify/build-image/compare/v2.7.1...v2.7.2) - 2019-04-12

### Merged

- Fix caching bugs [`#298`](https://github.com/netlify/build-image/pull/298)

## [v2.7.1](https://github.com/netlify/build-image/compare/v2.7.0...v2.7.1) - 2019-04-09

### Commits

- Update ZISI to 0.2.5 [`de9b179`](https://github.com/netlify/build-image/commit/de9b179c22a9aef31632dc4127b57ac6347faea3)

## [v2.7.0](https://github.com/netlify/build-image/compare/v2.6.15...v2.7.0) - 2019-04-09

### Merged

- Correct Hugo version [`#287`](https://github.com/netlify/build-image/pull/287)

### Commits

- Add zip-it-and-ship-it [`51e28bb`](https://github.com/netlify/build-image/commit/51e28bbf027c36c8b02d42824d1265e0c2016dca)
- Allow for staging branch builds [`6b56eef`](https://github.com/netlify/build-image/commit/6b56eef574e79348c8ead543fd90cdd3f0f09752)
- Add Go version to included software list [`f2f64fd`](https://github.com/netlify/build-image/commit/f2f64fd38e1a7eb2ab2908dbd591fa5bb5f9852c)

## [v2.6.15](https://github.com/netlify/build-image/compare/v2.6.14...v2.6.15) - 2019-03-14

### Commits

- Add bundler 1 for other older versions of ruby [`0efc09d`](https://github.com/netlify/build-image/commit/0efc09ddec9733ee7d067a1b9b96e1de5f35c66b)

## [v2.6.14](https://github.com/netlify/build-image/compare/v2.6.13...v2.6.14) - 2019-03-14

### Commits

- Include ruby 2.3.6 with old bundler [`1b49431`](https://github.com/netlify/build-image/commit/1b4943101ddcb395582135da38ec3a19f9198671)

## [v2.6.13](https://github.com/netlify/build-image/compare/v2.6.12...v2.6.13) - 2019-03-14

### Merged

- Update to ruby 2.6.2 [`#280`](https://github.com/netlify/build-image/pull/280)

### Commits

- Remove reference to master branch from README [`30f0d5e`](https://github.com/netlify/build-image/commit/30f0d5e78ab1f6921b47a0d10c46ae4954872fae)

## [v2.6.12](https://github.com/netlify/build-image/compare/v2.6.11...v2.6.12) - 2019-03-14

### Merged

- Fix heading level in README [`#277`](https://github.com/netlify/build-image/pull/277)
- Update readme and move included software list [`#276`](https://github.com/netlify/build-image/pull/276)
- ✨ Added doxygen [`#209`](https://github.com/netlify/build-image/pull/209)
- switch to LABEL, MAINTAINER is deprecated [`#271`](https://github.com/netlify/build-image/pull/271)
- Install libenchant1c2a package [`#253`](https://github.com/netlify/build-image/pull/253)
- Update the latest stable versions of ruby and use 2.5.3 by default [`#260`](https://github.com/netlify/build-image/pull/260)
- Bump test build ruby version [`#259`](https://github.com/netlify/build-image/pull/259)

### Commits

- Move included software to separate file [`f9f18a0`](https://github.com/netlify/build-image/commit/f9f18a0ea8fc8c6b9dcdd36931405acaca189a60)
- Revise README instructions (with image list) [`2939560`](https://github.com/netlify/build-image/commit/29395601eb2096e69bacb08589a9eb2059dd3d26)
- Include git tag in environment variable NF_IMAGE_TAG [`6e2fd6d`](https://github.com/netlify/build-image/commit/6e2fd6d9d6b9661647c344c2cf7b578c91d11379)
- Only squash tags [`b119a39`](https://github.com/netlify/build-image/commit/b119a3907b4af8c63e0c362026ae7c660fb9407e)
- Update the latest stable versions of ruby [`38cbea3`](https://github.com/netlify/build-image/commit/38cbea3ddf9c85a4d004f1b49e21253467d31b35)
- Update README.md [`0ea31d3`](https://github.com/netlify/build-image/commit/0ea31d3f37931d3f201ab6d26e413a5f2165db19)
- Update default versions in scripts [`8a81a1b`](https://github.com/netlify/build-image/commit/8a81a1b733d04b05723c912dc6f1b350b8c2844f)
- Use Node 10 LTS [`f72077e`](https://github.com/netlify/build-image/commit/f72077e4a04209f28c55179c4cfd14ff93056b79)
- Update README to reflect versions [`0f211a2`](https://github.com/netlify/build-image/commit/0f211a22ed42994d318175a6ed015ddda74e7240)
- Fix branch names [`1bf3c89`](https://github.com/netlify/build-image/commit/1bf3c89bb5e9c7ed79da3b84b0cbb3177252cb61)
- Start building dev branch [`cd7ac96`](https://github.com/netlify/build-image/commit/cd7ac96c156d14d682f77108706e658d43510e02)
- Update version of Hugo in README [`6102f24`](https://github.com/netlify/build-image/commit/6102f240629daddb34a7e3371040dbb774c2933b)
- Fix command substitution for binrc cache [`83656f7`](https://github.com/netlify/build-image/commit/83656f7b22b070402a25b7e991bc10ee8347a15b)
- Fix rvm install [`12d023e`](https://github.com/netlify/build-image/commit/12d023e72af73d40c20d6eb41ab01106df3f851f)
- Fix rvm install [`a3ad3c2`](https://github.com/netlify/build-image/commit/a3ad3c254406fc1325f455e9f6ad0bb254f05122)
- Add link to readme for local testing instructions [`b75c336`](https://github.com/netlify/build-image/commit/b75c33655e12415104db2a50a5f2c6534e5acea1)
- Update default version of go to 1.12 [`c9bcb7e`](https://github.com/netlify/build-image/commit/c9bcb7ec9ba97cdaa4123a94e2b6cbc95f46ae5a)
- :sparkles: Added doxygen [`bdaebbe`](https://github.com/netlify/build-image/commit/bdaebbe603d5f16c5fb6a6a877b40eda4930f84e)
- Print Hugo version when installing it [`52f6615`](https://github.com/netlify/build-image/commit/52f6615ae15e3f1a5c49f08d8837f2cc9f1f20d4)
- Merge pull request #229 from Vladekk/patch-1 [`199b382`](https://github.com/netlify/build-image/commit/199b3821a85c1bcac7abe0c13cb372f0334ca7f7)

## [v2.6.11](https://github.com/netlify/build-image/compare/v2.6.10...v2.6.11) - 2019-01-09

### Merged

- Partial revert of #197 [`#248`](https://github.com/netlify/build-image/pull/248)
