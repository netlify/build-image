...
# We install the hugo extended version by default https://gohugo.io/getting-started/installing/#debian-and-ubuntu
RUN case "$TARGETARCH" in \
      "arm64") HUGO_FILE="hugo_extended_${HUGO_VERSION}_Linux-ARM64.deb" ;; \
