...
- `focal` - In development and available for local testing; running Ubuntu 20.04 and [this software](https://github.com/netlify/build-image/blob/xenial/included_software.md)
